            ...
            if (empty($nome) || empty($login) || empty($email)) {
                ...
                if ($_POST['acao_usuario'] == 'adicionar') {
                    ...
                    if (empty($senha)) {
                        ...
                        if ($stmt) {
                            $stmt->bind_param("ssssssss", $nome, $login, $senha_pura, $pin, $email, $whatsapp, $nivel_acesso, $status);
                            if ($stmt->execute()) {
     ...
     <!-- NAVBAR -->
                        ...
                        <tr>
                           <!-- <td><img src="<#?php echo htmlspecialchars(!empty($usuario['avatar']) ? $usuario['avatar'] : '../caminho/padrao/avatar.png'); ?>" alt="Avatar" class="avatar-sm"></td>-->
                            ...
                            <td class="actions">
                                ...
                                <form method="POST" action="usuarios2.php" onsubmit="return confirm('Tem certeza que deseja excluir este usuário (<?php echo htmlspecialchars($usuario['nome']); ?>)?');">
      ...
      <div class="modal" id="usuarioModal">
        <div class="modal-dialog">
          <form method="POST" id="formUsuarioModal" action="usuarios2.php">
